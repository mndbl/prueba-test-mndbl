          ...
          <div className="flex bg-gray-100 p-10">
            <div className="mb-auto mt-auto max-w-lg">
              <div className="flex space-between">
                ...
                <h1 className="text-3xl uppercase w-2/3">About us</h1>
                <div className="w-1/3 text-right">
                  <a href="/about/our-neighbourhood"
                    className="text-sm py-2 no-underline capitalize border-2 border-blue-600 px-2 rounded-md hover:bg-blue-600 hover:text-white">Our Neighbourhood</a>
                </div>
              </div>
              ...
              <p className="text-justify">
                ...
                properties give people more ways to
                Connect, Enjoy & Relax, we have the experience and excellent group of people to make and unforgettable moments.
              </p>

              <h1 className="text-3xl uppercase block mt-4">Explore our brands</h1>
              <div className="flex space-x-2 mt-4 mb-8">
                ...
                <div className="w-1/2 border-2 border-gray-300 p-2 rounded-md">
                  ...
                  <p className="text-justify text-sm mt-2">
                    ...
                    discerning guests, members, asso-ciates, communities.
                  </p>
                </div>
              </div>
            </div>
